...
class Config(object):
	...
	DB_CHANNEL = int(os.environ["DB_CHANNEL"] , "-1003703513064")
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002784619700")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1003800962005")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://i.ibb.co/ym7N47X6/1296482719-28588.jpg")
...
🧑🏻‍💻 **DΞVΞLФPΞЯ:** [L͢a͢z͢y͢D͢e͢v͢e͢l͢o͢p͢e͢r͢r](https://t.me/KNMoviesHub17)

👥 **šupp⊕r† gr⊕up:** [LazY-SupP⊕ЯΓ](https://t.me/KNMoviesdiscussion)

📢 **U͢p͢d͢a͢t͢e͢s͢ C͢h͢a͢n͢n͢e͢l͢:** [L͢a͢z͢y͢D͢e͢v͢e͢l͢o͢p͢e͢r͢](https://t.me/KNMoviesHub17)
"""
	ABOUT_DEV_TEXT = f"""
